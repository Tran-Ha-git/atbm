...
public class RSAUtil {
	...
	public static byte[] encryptByPrivateKey(String data, String privateKey) throws BadPaddingException,
	...
	public static String decryptByPublicKey(byte[] data, PublicKey publicKey) throws NoSuchPaddingException,
			NoSuchAlgorithmException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
		Cipher cipher = Cipher.getInstance("RSA/ECB/PKCS1Padding");
...
//        try {
//            String encryptedString = Base64.getEncoder().encodeToString(encrypt("Thu Hà is the author", publicKey));
