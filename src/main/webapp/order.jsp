				...
				<div class="col-lg-12  m-0 p-3 row">
					<div class="col-lg-4">
						<div class="form-group ">
							<label for="name" class="mb-2 w-200">Họ & Tên: </label> <strong>${sessionScope.auth.fullname }</strong>
						</div>
						<div class="form-group ">
							<label for="phone" class="mb-2 w-200">Số điện thoại: </label> <strong>${sessionScope.auth.phone }</strong>
						</div>
					</div>
					<div class="col-lg-8">
						<div class="form-group ">
